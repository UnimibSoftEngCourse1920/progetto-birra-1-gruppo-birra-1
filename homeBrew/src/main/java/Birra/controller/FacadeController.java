...
public class FacadeController {
	...
	public boolean aggiungiIngrediente(String nome, String quantita, boolean bloccato, String tipo) throws IllegalArgumentException{
	...
	public boolean modificaIngrediente(String nome, String quantita, boolean bloccato, String tipo) throws IllegalArgumentException {
		if(ci.getIngrediente(nome)==null)
			return false;
	...
	private Ricetta creaRicetta(String nomeBirra, String tempo, String procedimento, Attrezzatura[] strumenti,
			Map<Ingrediente, Double> percentualiIngredienti, String titoloNota, String descrizioneNota) throws IllegalArgumentException {
		checkString(nomeBirra);
		return new Ricetta(nomeBirra, parseDouble(tempo), procedimento, strumenti, percentualiIngredienti, new Nota(titoloNota, descrizioneNota));
	}
	...
	public boolean aggiungiRicetta(String nomeBirra, String tempo, String procedimento, Attrezzatura[] strumenti,
		...
		if(cr.getRicetta(nomeBirra)!=null)
			return false;
		cr.aggiungiRicetta(creaRicetta(nomeBirra, tempo, procedimento, strumenti, percentualiIngredienti, titoloNota, descrizioneNota));
		return true;
	}
	...
	public boolean modificaRicetta(String nomeBirra, String tempo, String procedimento, Attrezzatura[] strumenti,
		...
		cr.modificaRicetta(creaRicetta(nomeBirra, tempo, procedimento, strumenti, percentualiIngredienti, titoloNota, descrizioneNota));
